...
// ─── DUMMY WIDGETS (tanpa import) ────────────────────────────────────────────

class NikCheckPage extends StatelessWidget {
  const NikCheckPage({super.key});
  @override
  Widget build(BuildContext context) => const Scaffold(body: Center(child: Text('NIK Check')));
}
...
class AdminPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(body: Center(child: Text('Admin: $sessionKey')));
}

class OwnerPage extends StatelessWidget {
  final String sessionKey, username;
  const OwnerPage({super.key, required this.sessionKey, required this.username});
  @override
  Widget build(BuildContext context) => Scaffold(body: Center(child: Text('Owner: $username')));
}

class HomePage extends StatelessWidget {
  final String username, password, role, expiredDate, sessionKey;
  final List<Map<String, dynamic>> listBug;
  const HomePage({super.key, required this.username, required this.password, required this.listBug, required this.role, required this.expiredDate, required this.sessionKey});
  @override
  Widget build(BuildContext context) => Scaffold(body: Center(child: Text('Home: $username')));
}
...
class SellerPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(body: Center(child: Text('Seller: $keyToken')));
}
...
class ChangePasswordPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(body: Center(child: Text('Change Password: $username')));
}
...
class ToolsPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(body: Center(child: Text('Tools: $userRole')));
}
...
class BugSenderPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(body: Center(child: Text('Bug Sender: $username')));
}
...
class ProfilePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(body: Center(child: Text('Profile: $username')));
}
...
class RiwayatPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(body: Center(child: Text('Riwayat: $role')));
}
...
class InfoPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(body: Center(child: Text('Info: $sessionKey')));
}
...
class _DashboardPageState extends State<DashboardPage>
  ...
  void _onNavTap(int index) {
    ...
    switch (index) {
      case 0: _navigate(_newsPage_()); break;
      case 1: _navigate(HomePage(
        username: username, password: password,
        listBug: listBug, role: role,
        expiredDate: expiredDate, sessionKey: sessionKey,
      )); break;
      case 2: _navigate(InfoPage(sessionKey: sessionKey)); break;
        ...
        children: [
          ...
          Padding(
            ...
            child: _ActionCard(
              ...
              title: 'Info Channel',
              subtitle: 'Join GengarCloud Info Channel',
  ...
  Widget _buildBottomNav() {
    final items = [
      ...
      _NavItem(icon: Icons.chat_rounded, label: 'WA Blast'),
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: [
            // Background color sebagai pengganti gambar
            Container(
              color: _C.surface,
              child: Center(
                child: Icon(
                  Icons.image_outlined,
                  color: _C.textDim.withOpacity(0.3),
                  size: 40,
                ),
              ),
            ),
      ...
      child: AnimatedScale(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(16),
            border: Border.all(
              color: _pressed ? widget.iconColor.withOpacity(0.3) : _C.border,
            ),
            boxShadow: _pressed
                        ...
                        child: ClipOval(
                          child: Container(
                            ...
                            child: Icon(_roleIcon(role),
                                size: 36, color: rColor.withOpacity(0.9)),
                          ),
                        ),
                      ),
                      Positioned(
